...
from data.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred, Dataset_sp500, \
    Dataset_aiops
...
class Exp_Informer(Exp_Basic):
    ...
    def train(self, setting):
        ...
        for epoch in range(self.args.train_epochs):
            ...
            #print(preds)
            #print(trues)
            #temp = int(preds.shape[0] / 24)
            #for num in range(0, temp):
                #preds1.append(preds[num * 24])
                #trues1.append(trues[num * 24])
            for num in range(0, preds.shape[0]):
                preds1.append(preds[num:0])
                trues1.append(trues[num:0])
    ...
    def test(self, setting):
        ...
        preds1 = np.array(preds1)
        trues1 = np.array(trues1)
        print('test shape:', preds1.shape, trues1.shape)
    ...
    def predict(self, setting, load=False):
       ...
       # print(pred_data)
        ...
        np.save(folder_path + 'real_prediction2.npy', [1,2,3,4])
        np.save(folder_path+'real_prediction.npy', preds)
    ...
    #def _process_one_batch(self, dataset_object, batch_x, batch_y):
        ...
        #batch_y = batch_y[:, -self.args.pred_len:, 0:38].to(self.device)
